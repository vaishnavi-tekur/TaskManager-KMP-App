                ...
                Row(Modifier.fillMaxWidth(), Arrangement.SpaceBetween, Alignment.CenterVertically) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column {
                            ...
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                Text(getTodayDate(), color = Color.White.copy(0.7f), fontSize = 14.sp)
        ...
        Card(Modifier.fillMaxWidth().padding(24.dp), RoundedCornerShape(16.dp), colors = CardDefaults.cardColors(Color.White)) {
            Column(Modifier.padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                if (screen == "login") {
                    ...
                    OutlinedButton(
                        onClick = {
                            googleLogin(scope) { email ->
                                if (email != null) {
                                    // 1. Check if the email domain is correct
                                    if (email.endsWith("@bhrish.com")) {
                                        scope.launch {
                                            // 2. Call the backend with the special "auto_login" password
                                        ...
                                        err = "Only @bhrish.com emails are allowed."
                                    }
                                }
                            }
                        },
