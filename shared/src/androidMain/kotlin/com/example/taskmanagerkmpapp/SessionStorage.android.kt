...
fun initializeSessionStorage(c: Context) { appContext = c.applicationContext }
private class AndroidSessionStorage(c: Context) : SessionStorage {
    ...
    override fun save(u: String, n: String, e: String, t: String) = p.edit().putString("user", u).putString("name", n).putString("email", e).putString("token", t).apply()
...
private object M : SessionStorage {
    ...
    override fun save(u: String, n: String, e: String, t: String) { v["user"] = u; v["name"] = n; v["email"] = e; v["token"] = t }
